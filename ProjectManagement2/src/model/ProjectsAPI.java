...
public class ProjectsAPI extends HttpServlet {
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*String id = request.getParameter("hidProjectIDSave");
		String pmid = request.getParameter("pmid");
		String fbid = request.getParameter("fbid");
		String Project_Name = request.getParameter("Project_Name");
		String start_date = request.getParameter("Start_Date");
		String deadline = request.getParameter("Deadline_Date");
		String status = request.getParameter("Project_Status");
		String proAmt = request.getParameter("Project_Fund_Amt");
		String sellAmt = request.getParameter("Project_Sell_Amt");

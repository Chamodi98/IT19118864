...
// execute the statement
	...
	public String readProjects() {
		...
		try {
			...
			output = "<table border='1'><tr><th>PM_ID</th><th>FB_ID</th><th>Project_Name</th><th>Start_Date</th><th>Deadline_Date</th><th>Project_Status</th><th>Project_Fund_Amt</th><th>Project_Sell_Amt</th>";
	...
	public String updateProject(String Project_ID, String pmid, String fbid, String Project_Name, String Start_Date, String Deadline_Date, String Project_Status, String Project_Fund_Amt, String Project_Sell_Amt) {
		...
		try {
			...
			preparedStmt.setInt(9, Integer.parseInt(Project_ID));
			// execute the statement
			...
			if(rowsUpdated > 0) {
				...
				output = "{\"status\":\"success\", \"data\": \"" + projects + "\"}";
			 }
			 else {
